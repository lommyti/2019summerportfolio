  ...
  render() {
    return (
      ...
      <div className="pos-relative ">
        <h2>Visual Design</h2>
        <button class="close-button" onClick={this.props.handler}>×</button>
        <p>This is a collection of one-off and non-software-related work I've done in the past!</p>
        <div class="row">
